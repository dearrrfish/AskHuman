...
export default {
  ...
  settings: {
    ...
    permissionRules: {
      ...
      manage: "Manage Conversation Grants…",
      panelTitle: "Conversation Grants",
      savedTitle: "Remembered grants",
      manageHint: "Review grants, turn off YOLO, or reset access in a separate panel.",
      refresh: "Refresh",
      loading: "Loading…",
      empty: "No remembered grants yet.",
      emptyHint: "Grants appear here after you choose an allow-for-conversation option in Codex.",
      globalGroup: "Cross-session grants (remembered by AskHuman)",
      globalHint: "Applies to every eligible Codex conversation",
      ...
      badgeDisk: "Full disk",
      badgeFiles: "Files {n}",
      badgeProjects: "Projects {n}",
      badgeShell: "Shell {n}",
      badgeNetwork: "Network {n}",
      badgeMcp: "MCP {n}",
      ...
      resetTitle: "Reset conversation grants?",
      resetSessionDesc: "This removes {n} grant(s) remembered by AskHuman for “{title}”. The next matching action will ask again.",
      resetGlobalDesc: "This removes {n} cross-session grant(s) remembered by AskHuman. The next matching action will ask again.",
      resetPermanentHint: "Permanent rules written to Codex configuration files are not affected.",
      resetConfirm: "Reset Grants",
      kindFileExact: "File",
  ...
  history: {
    ...
    scopeFilter: "History scope",
    allSessions: "All sessions",
    allProjectsAllSessions: "All sessions",
    thisProjectAllSessions: "Everything in this project",
    ...
    sessionMcp: "Approximate MCP session · {id} ({count})",
    sessionMcpCompact: "Approximate MCP session · {id}",
    sessionMcpFull: "MCP connection (approximate session)",
    sessionMcpDetail: "Approximate MCP session · {id}",
    sessionUnbound: "No session information ({count})",
    sessionUnboundCompact: "No session information",
    sessionMeta: "Session · {value}",
    cleanup: "Clean up",
    deleteSearchResults: "Delete current search results ({n})",
    clearSelectedSession: "Clear selected session history ({n})",
    clearSelectedProject: "Clear selected project history ({n})",
    clearAllCount: "Clear all history ({n})",
    deleteScopeProject: "Project",
    deleteScopeSession: "Session",
    deleteScopeKeywords: "Keywords",
    noKeywords: "None",
    confirmDeleteSearchTitle: "Delete the current search results?",
    confirmClearSelectedSessionTitle: "Clear the selected session history?",
    confirmClearSelectedProjectTitle: "Clear the selected project history?",
    confirmClearAllTitle: "Clear all history?",
    confirmDeleteSearchDesc:
      "This permanently removes the {n} current search results. New matching entries that appear after confirmation will not be deleted.",
    confirmClearSelectedSessionDesc:
      "This permanently removes the {n} existing entries in the selected session. New entries that appear after confirmation will not be deleted.",
    confirmClearSelectedProjectDesc:
      "This permanently removes the {n} existing entries in the selected project. New entries that appear after confirmation will not be deleted.",
    confirmClearAllDesc:
  ...
  console: {
    ...
    noSessions: "No sessions under this filter",
    selectHint: "Select a session to see its live status",
    waitingTitle: "Waiting for your answer",
    goAnswer: "Answer",
    activityHeading: "Latest activity ({time})",
    noActivity: "No activity yet",
    stepsOmitted: "… {n} earlier steps omitted",
    todoSummary: "TODO {done}/{total}",
    todoCurrent: " · current: {text}",
    step: {
      run: "Run",
      read: "Read",
      write: "Edit",
    },
    composerPlaceholder: "Message this agent (delivered at its next tool call)…",
    send: "Send",
    pendingCount: "{n} queued",
    pendingAttachments: "{n} attachment(s)",
    revoke: "Revoke",
    ...
    diff: {
      ...
      stage: "Stage",
      stageAll: "Stage all",
      stageAllConfirm: "Stage all {n} files?",
      confirm: "Confirm",
      skipped: "Content omitted",
    },
    tx: {
      open: "Full transcript",
      back: "Back to latest",
      loaded: "Full transcript · {loaded}/{total} loaded",
      loadOlder: "↑ Load {n} earlier (of {r})",
      begin: "Beginning of session",
      truncated: "Earlier content exceeds the parse limit",
      loading: "Loading…",
  ...
  todosWin: {
    ...
    dropOnTodo: "Drop to attach to this todo",
    dropOnNew: "Drop to attach to the new todo",
    pastedImageTooLarge: "A pasted image cannot exceed 10 MiB.",
    attachmentLimit: "A todo can have at most {n} attachments.",
    attachmentMissing: "missing",
    operationFailed: "Operation failed: {e}",
    storage: {
      managed: "managed",
      reference: "reference",
    },
  ...
  forkTask: {
    ...
    sourceContinues: "The source session will keep running.",
    forkedFrom: "forked from {id}",
    instruction: "What should the new branch do?",
    placeholder: "Enter instructions for the new branch…",
    launch: "Start fork",
    launching: "Starting…",
    launchNote: "Starts a native fork in a new Terminal window.",
    loadFailed: "Unable to load the source session: {e}",
    launchFailed: "Failed to launch fork: {e}",
    busyRetarget: "A fork is already launching; the source was not changed.",
  },
  interject: {
    ...
    attachmentUnavailable: "Source file is unavailable",
    send: "Send",
    cancel: "Cancel",
  },
};
